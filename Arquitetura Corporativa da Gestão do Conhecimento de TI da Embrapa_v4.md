...
5. **Governança editorial e descentralização**, estruturada em **6 Estantes independentes** que dividem o escopo Corporativo (Embrapa) e Local (Unidades) para cada público-alvo (Usuário Final, Equipe de TI e Administração de TI), operacionalizando a Regra 90/10 de proporção de conhecimento.
...
A arquitetura do conhecimento deve contemplar a realidade descentralizada da Embrapa, priorizando o conhecimento corporativo comum (90%) e tratando particularidades regionais ou de unidades locais (10%) de forma estruturada. Isso é alcançado dividindo a Base de Conhecimento em estantes lógicas segregadas por público (Usuário Final, Equipe de TI, Administração) e por escopo (Embrapa vs. Unidades), totalizando **6 Estantes Corporativas** que evitam a duplicação ou fragmentação das informações comuns.
...
| :--- | :--- | :--- | :--- |
| **📚 Usuário Final - Embrapa** | Todos os colaboradores | Autoatendimento de ferramentas e sistemas corporativos comuns | Central (Sede / Gestão de Processos) |
| **📚 Usuário Final - Unidades** | Usuários de unidades específicas | Particularidades locais de autoatendimento das 44 unidades | Descentralizada (TI da respectiva Unidade) |
| **📚 Equipe de TI - Embrapa** | Analistas de TI (Sede/Unidades) | Documentação técnica corporativa, infraestrutura e runbooks globais | Co-criada (Nível corporativo) |
| **📚 Equipe de TI - Unidades** | Analistas de TI local | Particularidades de infraestrutura, redes e servidores locais da Unidade | Descentralizada (TI da respectiva Unidade) |
| **📚 Administração de TI - Embrapa** | Gestores de TI e Segurança | Governança, normativas, planejamento estratégico e contratos globais | Sede (Secretaria de TI) |
| **📚 Administração de TI - Unidades** | Chefes de TI local e Diretores | Inventários locais, contratos de TI locais e planos de contingência | Descentralizada (Chefia de TI da Unidade) |

Essa organização permite aplicar políticas distintas de acesso, ciclo de vida do conhecimento e indexação para IA (RAG).

### 📚 Estante: Usuário Final - Embrapa
...
### 📚 Estante: Usuário Final - Unidades
...
**Características:** Organizada com um livro para cada unidade (ex: `📖 Embrapa Cerrados - Usuário Final`), contendo ramais locais, particularidades de impressão local, regras locais de acesso físico ou agendamento de recursos locais.
**Exemplos de Livros:** Embrapa Gado de Corte, Embrapa Cerrados, Embrapa Trigo.

### 📚 Estante: Equipe de TI - Embrapa
...
### 📚 Estante: Administração de TI - Embrapa
...
### 📚 Estante: Administração de TI - Unidades
...
|-------|--------|----------|
| **Estantes** | Estrutura de Domínio - Público - Escopo | `Usuário Final - Embrapa`, `Equipe de TI - Unidades`, `Administração de TI - Embrapa` |
...
**Navegação hierárquica** — quando o usuário deseja explorar um assunto: Equipe TI → PostgreSQL → Backup e Recuperação → *Como restaurar backup*.
...
❌ `unidade` (quando a unidade já estiver representada pelo Livro dentro das estantes dedicadas a Unidades, como "Equipe de TI - Unidades" ou "Usuário Final - Unidades")
...
# CAPÍTULO 6 — GOVERNANÇA CORPORATIVA E DESCENTRALIZAÇÃO
...
```text
📚 Usuário Final - Unidades
├── 📖 Embrapa Cerrados - Usuário Final
│   ├── 📂 Ramais e Contatos Locais
│   ├── 📂 Impressão Local
│   └── 📂 Regras de Convivência e Acesso Local
└── 📖 Embrapa Gado de Corte - Usuário Final

📚 Equipe de TI - Unidades
├── 📖 TI - Embrapa Cerrados
│   ├── 📂 Servidores Locais
│   ├── 📂 Infraestrutura de Rede Local
...
```text
📚 Usuário Final - Embrapa (Central)
└── 📖 Impressão → 📄 Como configurar a impressora corporativa padrão

📚 Usuário Final - Unidades (Local)
└── 📖 Embrapa Cerrados - Usuário Final → 📂 Impressão Local → 📄 Como configurar a impressora do Laboratório X
```
...
1. **Camada 1 — Conhecimento Corporativo:** Representa a fonte padrão de verdade para toda a instituição. Armazena conceitos, sistemas e procedimentos que possuem aplicação global nas estantes centrais: `Usuário Final - Embrapa`, `Equipe de TI - Embrapa` e `Administração de TI - Embrapa`.
...
3. **Camada 3 — Conhecimento Local da Unidade:** Contém exclusivamente as particularidades técnicas, operacionais ou administrativas da Unidade Descentralizada. É armazenado na respectiva estante de Unidade (`Usuário Final - Unidades`, `Equipe de TI - Unidades` ou `Administração de TI - Unidades`), dentro do livro da UD respectiva.
